...
struct PaywallView: View {
    ...
    private let benefits: [(String, String, String)] = [
        ("infinity", "Unlimited debts", "Track every card, loan and bill — not just two."),
        ("arrow.triangle.swap", "Snowball vs Avalanche", "Compare both methods and see which saves the most interest."),
        ("calendar.badge.clock", "Payoff-date projection", "Know the exact month you'll be debt-free."),
        ("square.and.arrow.up.fill", "Share your progress", "Share your plan and milestones in one tap.")
    ]
            ...
            ScrollView {
                VStack(spacing: 22) {
                    VStack(spacing: 8) {
                        ...
                        Text("Snowball Pro").font(.largeTitle.weight(.heavy))
                    ...
                    VStack(spacing: 12) {
                        Button { Task { await buy() } } label: {
                            HStack {
                                ...
                                Text(working ? "Unlocking…" : "Unlock Snowball Pro · \(store.displayPrice)")
                                    .font(.headline)
                            }
                        ...
                        Text("Snowball never tracks you. Your debts stay on your device.")
